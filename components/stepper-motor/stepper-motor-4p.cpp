...
static constexpr size_t kSequenceLen      = sizeof(kSequenceArray) / sizeof(kSequenceArray[0]);

StepperMotor4P::StepperMotor4P(int steps_per_rotation,
                               gpio_num_t motor_pin_0,
